            ...
            <div className="col-lg-8 col-md-8 text-center">
              ...
              <ul className="nav nav-pills nav-pills-info align-items-center">
                <li className="nav-item h5">
                  <a className="nav-link active" dataToggle="tab" href="#link1" >Public Relations &
                    Marketing</a>
                </li>
                <li className="nav-item h5">
                  <a className="nav-link" dataToggle="tab" href="#link2">Sponsorship</a>
                </li>
                <li className="nav-item h5">
                  <a className="nav-link" dataToggle="tab" href="#link3" >Graphic & Web Design</a>
                </li>
                <li className="nav-item h5">
